...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const RAND_GREET = GREET_LST[Math.floor(Math.random() * GREET_LST.length)];
...
const NameIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        let clip1 = 'https://happybirthdaytoyou.s3-eu-west-1.amazonaws.com/Funny+Hindi+Birthday+Song+-+Funzoa+Mimi+Teddy+Perfect+Song+For+Your+Friends+%26+Family-%5BAudioTrimmer.com%5D.mp3';
        let clip2 = 'https://happybirthdaytoyou.s3-eu-west-1.amazonaws.com/ac.mp3';
        const RAND_WISH = WISH_LST[(Math.random() * 100) % WISH_LST.length];
        const speakOutput = 'Here is a birthday song for ' + name1 + '<break time="2s"/>' + '<audio src="' + clip1 + '" />' + '<audio src="' + clip2 + '" />' + RAND_WISH + ' enjoy!';
